...
- **Adult Content Sites (porno.txt)**:
  - `https://raw.githubusercontent.com/Mitroline/automatic-octo-giggle/release/porno.txt`
  - `https://cdn.jsdelivr.net/gh/Mitroline/automatic-octo-giggle@release/porno.txt`

- **Discord (discord.txt)**:
  - `https://raw.githubusercontent.com/Mitroline/automatic-octo-giggle/release/discord.txt`
  - `https://cdn.jsdelivr.net/gh/Mitroline/automatic-octo-giggle/discord.txt`

- **YouTube (youtube.txt)**:
  - `https://raw.githubusercontent.com/Mitroline/automatic-octo-giggle/release/youtube.txt`
  - `https://cdn.jsdelivr.net/gh/Mitroline/automatic-octo-giggle@release/youtube.txt`

- **Social Networks (socials.txt)**:
  - `https://raw.githubusercontent.com/Mitroline/automatic-octo-giggle/release/socials.txt`
  - `https://cdn.jsdelivr.net/gh/Mitroline/automatic-octo-giggle@release/socials.txt`

- **Torrent Sites (torrent.txt)**:
  - `https://raw.githubusercontent.com/Mitroline/automatic-octo-giggle/release/torrent.txt`
  - `https://cdn.jsdelivr.net/gh/Mitroline/automatic-octo-giggle@release/torrent.txt`

- **Developer Tools (tools.txt)**:
  - `https://raw.githubusercontent.com/Mitroline/automatic-octo-giggle/release/tools.txt`
  - `https://cdn.jsdelivr.net/gh/Mitroline/automatic-octo-giggle@release/tools.txt`

- **Music Services (music.txt)**:
  - `https://raw.githubusercontent.com/Mitroline/automatic-octo-giggle/release/music.txt`
  - `https://cdn.jsdelivr.net/gh/Mitroline/automatic-octo-giggle@release/music.txt`

- **Roblox (roblox.txt)**:
  - `https://raw.githubusercontent.com/Mitroline/automatic-octo-giggle/release/roblox.txt`
  - `https://cdn.jsdelivr.net/gh/Mitroline/automatic-octo-giggle@release/roblox.txt`
...
rule-providers:
  porno:
    type: http
    behavior: domain
    url: "https://cdn.jsdelivr.net/gh/Mitroline/automatic-octo-giggle@release/porno.txt"
  ...
  discord:
    type: http
    behavior: domain
    url: "https://cdn.jsdelivr.net/gh/Mitroline/automatic-octo-giggle@release/discord.txt"
  ...
  youtube:
    type: http
    behavior: domain
    url: "https://cdn.jsdelivr.net/gh/Mitroline/automatic-octo-giggle@release/youtube.txt"
  ...
  socials:
    type: http
    behavior: domain
    url: "https://cdn.jsdelivr.net/gh/Mitroline/automatic-octo-giggle@release/socials.txt"
  ...
  torrent:
    type: http
    behavior: domain
    url: "https://cdn.jsdelivr.net/gh/Mitroline/automatic-octo-giggle@release/torrent.txt"
  ...
  tools:
    type: http
    behavior: domain
    url: "https://cdn.jsdelivr.net/gh/Mitroline/automatic-octo-giggle@release/tools.txt"
  ...
  music:
    type: http
    behavior: domain
    url: "https://cdn.jsdelivr.net/gh/Mitroline/automatic-octo-giggle@release/music.txt"
...
3. Replace `Mitroline/automatic-octo-giggle` in README with actual values
